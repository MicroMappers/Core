...
public class StatusCodeType {
    ...
    public static String EXCEPTION_STRING = "Exception";
    public static String TABLE_NAME = "clientApp";
    public static String COLMN_NAME = "importQueueSize";


    public static Integer CLIENT_ACTIVE = 1;
