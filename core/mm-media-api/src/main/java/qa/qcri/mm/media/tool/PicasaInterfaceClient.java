...
public class PicasaInterfaceClient {
     ...
     */
    public PicasaInterfaceClient(PicasawebService service) {
     ...
     */
    public PicasaInterfaceClient(PicasawebService service, String uname, String passwd) {
