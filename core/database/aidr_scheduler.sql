...
--
-- Host: localhost
-- Generation Time: Mar 11, 2015 at 01:53 PM
...
--
CREATE DATABASE `aidr_scheduler` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `aidr_scheduler`;
...
CREATE TABLE `clientAppSource` (
  ...
  UNIQUE KEY `clientAppSourceID_UNIQUE` (`clientAppSourceID`)
...
CREATE TABLE `lookup` (
  ...
  `columnValue` varchar(250) NOT NULL,
  `description` varchar(200) NOT NULL,
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6888 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=110976 ;
