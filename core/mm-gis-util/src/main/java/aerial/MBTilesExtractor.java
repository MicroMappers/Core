...
public class MBTilesExtractor {
    ...
    public static void main(String[] args)  {
        try {
            File dir = new File("/Users/jlucas/Documents/DevTest/mbutil/vanatu/19");
            ...
            if (dirList !=null) {
                for (int i=0; i<dirList.length; i++) {
                    ...
                    if(xFolder.getName().indexOf(".DS_Store") == -1){
                        ...
                        String yPath = "/Users/jlucas/Documents/DevTest/mbutil/vanatu/19" + File.separator + xFolder.getName();
                        ...
                        for (int j=0; j<yList.length; j++) {
                            ...
                            if(y.getName().indexOf(".DS_Store") == -1){
                                ...
                                //if(!url.isEmpty()){
                                    ...
                                    String url = generateStaticMapAPIUrl(tile2lat(yPoint), tile2long(xPoint), 19);
                                    if(isValidURL(url)) {
   ...
   **/
    ...
    //http://api.tiles.mapbox.com/v4/uaviators.fjb3uy6e/168.31878662109375,-17.74345487051767,19/600x600.png?access_token=pk.eyJ1IjoidWF2aWF0b3JzIiwiYSI6IlpqZEx2UzgifQ.o6vACHfsO6CTk2yluUZwUA
        return "http://api.tiles.mapbox.com/v4/uaviators.fjb3uy6e/" + lng + "," + lat + ",19/800x800.png?access_token=pk.eyJ1IjoidWF2aWF0b3JzIiwiYSI6IlpqZEx2UzgifQ.o6vACHfsO6CTk2yluUZwUA";
    ...
    private static String generateFilePath(String x, String y){
        ...
        String aTile = "https://a.tiles.mapbox.com/v4/uaviators.fjb3uy6e/19/" + x + "/" + y + "@2x.png?access_token=pk.eyJ1IjoidWF2aWF0b3JzIiwiYSI6IlpqZEx2UzgifQ.o6vACHfsO6CTk2yluUZwUA";
        if(isValidURL(aTile)) {
            return aTile;
        }
        ...
        String bTile = "https://b.tiles.mapbox.com/v4/uaviators.fjb3uy6e/19" + x + "/" + y + "@2x.png?access_token=pk.eyJ1IjoidWF2aWF0b3JzIiwiYSI6IlpqZEx2UzgifQ.o6vACHfsO6CTk2yluUZwUA";
