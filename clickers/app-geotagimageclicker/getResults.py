...
if __name__ == "__main__":
    ...
    if (options.results):
        ...
        app = pbclient.find_app(short_name='ImageGeoClicker')[0]
        ...
        while completed_tasks:
            for t in completed_tasks:
                ...
                for a in answers:
                    ...
                    if t.info['url']:
                        line.append(t.info['url'].encode('utf-8', 'ignore'))
                    else:
                        line.append("")

                    if t.info['long']:
                        line.append(t.info['long'].encode('utf-8', 'ignore'))
                    else:
                        line.append("")

                    if t.info['lat']:
                        line.append(t.info['lat'].encode('utf-8', 'ignore'))
                    else:
                        line.append("")

                    if t.info['imgurl']:
                        line.append(t.info['imgurl'].encode('utf-8', 'ignore'))
                    else:
                        line.append("")
